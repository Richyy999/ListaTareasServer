...
public final class Acciones {
	...
	public static final int ACCION_ACEPTAR_TERMINOS = 2;

	public static final int ACCION_OBTENER_MESES = 11;
	public static final int ACCION_ANADIR_TAREA = 12;
	...
	public static final int ACCION_MODIFICAR_TAREA_CONFIG = 23;
	public static final int ACCION_ELIMINAR_TAREA_CONFIG = 24;
	public static final int ACCION_VER_HABITACIONES_CONFIG = 25;
